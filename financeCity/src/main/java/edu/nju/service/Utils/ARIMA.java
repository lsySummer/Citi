...
import edu.nju.service.Utils.Arima.AR;
import edu.nju.service.Utils.Arima.ARMA;
import edu.nju.service.Utils.Arima.ARMAMath;
import edu.nju.service.Utils.Arima.MA;
...
public class ARIMA {
	...
	public double getReulst() {
		...
		return aftDeal(predictValue(model[0],model[1]));
	}
