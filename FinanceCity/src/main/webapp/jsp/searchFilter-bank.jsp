...
<head>
    ...
    <script type="text/javascript" rel="script" src="js/searchFilter-bank.js"></script>
    ...
    <div class="filter-container">
        ...
        <div class="income-wrapper">
            ...
            <div class="input-add-on income-item">
                ...
                <div class="slider-wrapper input-add-on-field">
                    <input type="text" id="purchase_amount" name="purchase_amount" value="" class="input-add-on-field"/>
                </div>
            </div>
            <div class="input-add-on income-item">
        ...
        <div class="income-wrapper">
            ...
            <div class="input-add-on income-item">
                ...
                &nbsp;&nbsp;
                <input type="checkbox" checked data-toggle="toggle" data-size="small" data-height="30px" data-on="是" data-off="否" data-onstyle="info">
            </div>
        </div>
    </div>
</div>
