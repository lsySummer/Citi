    ...
    <div class="filter-container">
        ...
        <div class="income-wrapper">
            ...
            <div class="input-add-on income-item">
                <label>起购金额</label>
                <div class="slider-wrapper input-add-on-field">
                    <b class="slider-start">0</b><input id="purchase_amount" type="text" class="span2" value="" data-slider-min="10" data-slider-max="1000" data-slider-step="5" data-slider-value="[250,450]"/><b class="slider-end">1000</b>
                </div>
            </div>
            <div class="input-add-on income-item">
                <label>期限</label>
